...
deploy:
	@forge script script/DeployBasicNFT.s.sol:DeployBasicNFT $(NETWORK_ARGS) --force

mint:
	@forge script script/Interactions.s.sol:MintBasicNFT ${NETWORK_ARGS} --force

deployMood:
	@forge script script/DeployMoodNFT.s.sol:DeployMoodNFT $(NETWORK_ARGS) 

mintMoodNft:
	@forge script script/Interactions.s.sol:MintMoodNFT $(NETWORK_ARGS) --force

flipMoodNft:
	@forge script script/Interactions.s.sol:FlipMoodNFT $(NETWORK_ARGS) --force
